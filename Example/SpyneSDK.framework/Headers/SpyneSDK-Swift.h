...
#ifndef SPYNESDK_SWIFT_H
#define SPYNESDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SpyneSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC8SpyneSDK15BeforeAfterView")
...
SWIFT_CLASS("_TtC8SpyneSDK11BlockButton")
...
SWIFT_CLASS("_TtC8SpyneSDK14BlockLongPress")
...
/// Make sure you use  “[weak self] (gesture) in” if you are using the keyword self inside the closure or there might be a memory leak
SWIFT_CLASS("_TtC8SpyneSDK8BlockPan")
...
/// Make sure you use  “[weak self] (gesture) in” if you are using the keyword self inside the closure or there might be a memory leak
SWIFT_CLASS("_TtC8SpyneSDK10BlockPinch")
...
/// Make sure you use  “[weak self] (gesture) in” if you are using the keyword self inside the closure or there might be a memory leak
SWIFT_CLASS("_TtC8SpyneSDK10BlockSwipe")
...
/// Make sure you use  “[weak self] (gesture) in” if you are using the keyword self inside the closure or there might be a memory leak
SWIFT_CLASS("_TtC8SpyneSDK8BlockTap")
...
@interface NSHTTPURLResponse (SWIFT_EXTENSION(SpyneSDK))
...
SWIFT_CLASS("_TtC8SpyneSDK16MaterialShowcase")
...
@interface MaterialShowcase (SWIFT_EXTENSION(SpyneSDK))
...
SWIFT_PROTOCOL("_TtP8SpyneSDK24MaterialShowcaseDelegate_")
@protocol MaterialShowcaseDelegate
@optional
...
SWIFT_CLASS("_TtC8SpyneSDK31MaterialShowcaseInstructionView")
...
@interface UINavigationController (SWIFT_EXTENSION(SpyneSDK))
...
@interface UIView (SWIFT_EXTENSION(SpyneSDK))
