...
open class MaterialShowcase: UIView {
  ...
  @objc public var aniRippleAlpha: CGFloat = 0.0
    ...
    @objc public var primaryTextPositionX: CGFloat = 0.0
    @objc public var primaryTextPositionY: CGFloat = 0.0
  // Delegate
...
extension MaterialShowcase {
  ...
  private func addBackground() {
    ...
    case .full:
        backgroundView = UIView(frame: CGRect(x: 0, y: 0, width: ScreenSize.SCREEN_WIDTH*2 ,height: ScreenSize.SCREEN_HEIGHT*2))
    }
