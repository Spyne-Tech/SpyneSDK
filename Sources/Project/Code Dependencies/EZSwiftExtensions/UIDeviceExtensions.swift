...
extension UICollectionView{
    ...
    func registerNIB(cellName name :String){
        ...
        self.register(UINib(nibName: name, bundle: Bundle.spyneSDK), forCellWithReuseIdentifier: name)
    }
...
extension UITableView{
    ...
    func registerNIB(cellName name :String){
        ...
        self.register(UINib(nibName: name, bundle: Bundle.spyneSDK), forCellReuseIdentifier: name)
    }
